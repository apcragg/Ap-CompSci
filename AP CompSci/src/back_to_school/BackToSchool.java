...
public class BackToSchool
{
	...
	private void run()
	{
		Student austin = new Student("Austin Vassallo", 18, "M", "1BA2389AC",
				3.55);
		System.out.println(austin);

		Teacher scheidler = new Teacher("Krysten Shceidler", 28, "F", 650000,
				"Physics");
		...
		CollegeStudent mackenzie = new CollegeStudent("Mackenzie Maison", 19,
				"M", "VT2014", 4.0, "Biology", 1);
